...
m = Map("modem", translate("移远RM520N内置模组移动网络设置"))
section = m:section(TypedSection, "ndis", translate("蜂窝设置（当前配置为内置模组,非网络AT方式）"))
...
simsel:value("3", translate("外置SIM卡2"))
simsel:value("4", translate("外置SIM卡3"))
simsel:value("5", translate("外置SIM卡4"))
