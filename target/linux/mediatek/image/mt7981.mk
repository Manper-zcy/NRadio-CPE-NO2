...
define Device/nradio_wt9108_No2-manper_650_v
  DEVICE_VENDOR := NRADIO
  DEVICE_MODEL := C8-No2-vende-zcy
  DEVICE_DTS := mt7981-nradio-wt9108-No2-650-v
  DEVICE_DTS_DIR := $(DTS_DIR)/mediatek
  SUPPORTED_DEVICES := nradio,wt9108
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  ...
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
TARGET_DEVICES += nradio_wt9108_No2-manper_650_v

define Device/nradio_wt9111_No2-manper_NB68
  DEVICE_VENDOR := NRADIO
  DEVICE_MODEL := C8-NB68-No2-manper
  DEVICE_DTS := mt7981-nradio-wt9111-NB68-No2
  DEVICE_DTS_DIR := $(DTS_DIR)/mediatek
  SUPPORTED_DEVICES := nradio,wt9111
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  IMAGE_SIZE := 131072k
  ...
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
TARGET_DEVICES += nradio_wt9111_No2-manper_NB68

define Device/nradio_wt9116_No2-manper_C5800
  DEVICE_VENDOR := NRADIO
  DEVICE_MODEL := C8-C5800-No2-manper
  DEVICE_DTS := mt7981-nradio-wt9116-5800-No2
  DEVICE_DTS_DIR := $(DTS_DIR)/mediatek
  SUPPORTED_DEVICES := nradio,wt9116
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  IMAGE_SIZE := 131072k
  ...
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
TARGET_DEVICES += nradio_wt9116_No2-manper_C5800

define Device/nradio_wt9116_No2-manper_688
  DEVICE_VENDOR := NRADIO
  DEVICE_MODEL := C8-688-No2-manper
  DEVICE_DTS := mt7981-nradio-wt9116-688-No2
  DEVICE_DTS_DIR := $(DTS_DIR)/mediatek
  SUPPORTED_DEVICES := nradio,wt9116
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  ...
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
TARGET_DEVICES += nradio_wt9116_No2-manper_688
