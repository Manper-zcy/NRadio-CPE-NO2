...
if test -n "$STAGING_DIR"; then
	...
	: ${EGREP="/home/zhouwei/immortalwrt-mt798x/staging_dir/host/bin/grep -E"}
	: ${FGREP="/home/zhouwei/immortalwrt-mt798x/staging_dir/host/bin/grep -F"}
	: ${GREP="/home/zhouwei/immortalwrt-mt798x/staging_dir/host/bin/grep"}
	: ${SED="/home/zhouwei/immortalwrt-mt798x/staging_dir/host/bin/sed"}
fi
